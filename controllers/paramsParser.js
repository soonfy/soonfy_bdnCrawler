...
const paramsParser = {
  /**
   * baidu news method, compare two dates
   * @method dataCompare
   * @param {any} asStartDate
   * @param {any} asEndDate
   * @returns
   */
  ...
  /**
   * baidu news method, string is date
   * @method isDateString
   * @param {any} sDate
   * @returns
   */
  ...
  /**
   * baidu news method, transfrom string to date
   * @method stringToDate
   * @param {any} sDate
   * @param {any} bIgnore
   * @returns
  ...
  /**
   * baidu news method, parse params from param
   * @method parse
   * @param {any} params
   * @returns
   */
